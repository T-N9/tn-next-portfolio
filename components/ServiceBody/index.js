        ...
        <Element name={"services_section"}>
          ...
          <div className="service_body--grid">
            ...
            <div className="service_body--card">
              ...
              <div>
                ...
                <p>
                  Reaching project goals by identifying customer requirements
                  and prototyping before diving into an actual project are my
            ...
            <div className="service_body--card">
              ...
              <div>
                ...
                <p>
                  To be a reachable and engaging website, the implementation
                  must proceed prioritizing SEO support concepts.
                </p>
              </div>
            </div>
            ...
            <div className="service_body--card">
              ...
              <div>
                ...
                <p>
                  I use React.js to build scalable, reusable, maintainable, and
                  to provide fast Single Page Applications.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="service_body--promote">
            ...
            <p className="para">
              ...
              performance. Nowadays, there are so many ways to create web
              content but to attract users at the very first seconds of your
              webpage, the content has to be clear and interactive to various
              devices.
              <br />
              <br />
